    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center px-4">
      <div className="w-full max-w-[420px]">
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <h1 className="text-[30px] sm:text-[35px] font-semibold leading-none">Create an account</h1>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-5">
              ...
              <div className="h-10 rounded-xl bg-white/10 border border-white/10 flex items-center px-4">
                <FiUser className="text-white/40 text-[18px]" />
                <input
                  name="username"
                  type="text"
        ...
        <div className="mt-6 text-center text-sm text-white/35">
          ...
          <div className="mt-2">We use AES-256 encryption to protect your notes</div>
        </div>
      </div>
    </div>
  );
